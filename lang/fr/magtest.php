...
$string['categorydeleteconfirm'] = 'Etes vous sûr de vouloir supprimer cette catégorie ?';
...
$string['questiondeleteconfirm'] = 'Etes vous sûr de vouloir supprimer cette question ?';
