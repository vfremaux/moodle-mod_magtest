...
echo '<p>';
echo $OUTPUT->single_button(new moodle_url($CFG->wwwroot . '/mod/magtest/editcategories.php', $params), get_string('addone', 'magtest'), 'get');
$options['howmany'] = 3;
echo $OUTPUT->single_button(new moodle_url($CFG->wwwroot . '/mod/magtest/editcategories.php', $params), get_string('addthree', 'magtest'), 'get');
echo "</center>";
echo '</p>';
