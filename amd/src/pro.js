...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var magtestpro = {
        ...
        component: 'mod_magtest',
        shortcomponent: 'magtest',
        componentpath: 'mod/magtest',

        init: function() {

            var licensekeyid = '#id_s_' + magtestpro.shortcomponent + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + magtestpro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = magtestpro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + magtestpro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + magtestpro.shortcomponent + '_licenseprovider').val();
